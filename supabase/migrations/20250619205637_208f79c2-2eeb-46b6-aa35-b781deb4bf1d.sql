...
-- First, drop the existing tasks table and all its constraints
DROP TABLE IF EXISTS public.tasks CASCADE;

-- Create a new tasks table that properly references the clients table
...
-- Clients can view tasks assigned to them through the clients table
