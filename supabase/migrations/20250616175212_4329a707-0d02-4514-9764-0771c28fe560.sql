...
-- Handle the existing user_role enum gracefully
DO $$ BEGIN
...
-- Create the function with the correct enum reference
...
-- Update the profiles table to use the enum (only if not already using it)
DO $$ BEGIN
    IF NOT EXISTS (
