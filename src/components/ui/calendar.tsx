  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-neutral-700 text-primary-foreground hover:bg-neutral-950 hover:text-primary-foreground focus:bg-neutral-700 focus:text-primary-foreground",
        day_today: "bg-accent text-accent-foreground",
        day_outside:
          "day-outside text-neutral-50 opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30",
